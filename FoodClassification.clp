...
(deftemplate Element (slot class (type STRING)) (slot eColor (type STRING)) (slot iColor (type STRING)) (slot taste (type STRING)) (slot contexture (type STRING)) (slot size (type STRING)) (slot shape (type STRING)) (slot InSeed (type STRING)) (slot subcategory (type STRING)) )
